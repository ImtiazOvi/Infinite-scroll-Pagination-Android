package com.example.practicepagination.utlis;
...
public abstract class EndlessRecyclerViewScroll extends RecyclerView.OnScrollListener {
    ...
    public static int current_page = 1;               // The current offset index of data you have loaded
    public static int previousTotal = 0;              // The total number of items in the RecyclerView after the last load
    ...
    public static void resetEndlessRecyclerViewScroll() {
        loading = true;
        current_page = 1;
        previousTotal = 0;
    }
